                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Selamat datang di SIPADTBC</h4>
                            </div>
                            <div class="card-body">
                                {{-- content --}}
                                <p>SIPADTBC adalah aplikasi yang dibuat untuk diagnosa penyakit TBV.</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                {{-- content --}}
                                <p>Untuk melihat informasi penyakit TBC, klik <a
